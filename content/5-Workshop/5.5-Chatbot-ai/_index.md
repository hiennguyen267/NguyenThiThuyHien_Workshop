...
3. Review all configuration settings and click **Create bucket**.
   ...
   ![Create an S3 bucket for the knowledge base](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai1.jpg)
...
5. Check the file names, file sizes, and upload status before starting the indexing process.
   ...
   ![Knowledge base folder structure in Amazon S3](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai2.jpg)
...
5. The model creates vectors with **1024 dimensions** and supports multiple languages, making it suitable for the Vietnamese knowledge base used by PharmaCare.
   ...
   ![Cohere Embed Multilingual model in Amazon Bedrock](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai3.jpg)
...
3. This model is used to generate natural-language responses when the `ENABLE_LLM=true` environment variable is enabled.
   ...
   ![Amazon Nova Micro model in Amazon Bedrock](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai4.jpg)
...
3. Configure the following values:
   ...
   * **Outbound rules:** Allow Lambda to send HTTPS requests to the required AWS services.
   ...
   ![Security Group for AI Lambda functions](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai5.jpg)
...
3. The outbound rule can remain at its default value.
   ...
   ![Security Group for AI VPC Endpoints](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai6.jpg)
...
4. Create the endpoint and confirm that its status changes to `Available`.
   ...
   ![S3 Gateway Endpoint for AI Lambda functions](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai7.jpg)
...
3. Confirm that the endpoint status is `Available`.
   ...
   ![Bedrock Runtime Interface Endpoint](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai8.jpg)
...
3. Confirm that the endpoint status is `Available`.
   ...
   ![OpenSearch Serverless VPC Endpoint](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai9.jpg)
...
This endpoint handles index creation, vector insertion, and data queries from the Lambda functions.
   ...
   ![OpenSearch Serverless Data Endpoint](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai10.jpg)
...
6. Create two additional inline policies:
   ...
   * `pharmacare-rag-access-policy`.
   ...
   ![IAM Role for the Indexing and Chatbot Lambda functions](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai11.jpg)
...
```
   ...
   ![IAM policy for accessing Amazon Bedrock models](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai12.jpg)
...
```
   ...
   ![IAM policy for accessing the knowledge base and Vector Store](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai13.jpg)
...
5. Record the OpenSearch endpoint for the Lambda configuration.
   ...
   ![PharmaCare OpenSearch Serverless Vector Store](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai14.jpg)
...
* **Permissions:**
  ...
  ```
   ...
   ![Data Access Policy for OpenSearch Serverless](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai15.jpg)
...
4. Package the source code with all dependencies and deploy it to Lambda. The AWS Toolkit extension in Visual Studio Code can also be used by selecting **Deploy (Ctrl+Shift+U)**.
   ...
   ![Indexing Lambda source code](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai16.jpg)
...
| `OPENSEARCH_INDEX` | `pharmacare-knowledge-index` |
   ...
   ![Environment variables of the Indexing Lambda function](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai17.jpg)
...
5. The system test produced the following results:
   ...
   * Successfully stored the data in the OpenSearch Vector Store.
   ...
   ![Indexing Lambda test result](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai18.jpg)
...
3. Deploy the chatbot source code to Lambda.
   ...
   ![PharmaCare Chatbot Lambda function](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai19.jpg)
...
| `TOP_K` | `3` |
   ...
   ![Environment variables of the Chatbot Lambda function](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai20.jpg)
...
* No timeout, DNS, or IAM permission errors occur.
   ...
   ![Chatbot Lambda test result](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai21.jpg)
...
8. Configure the API endpoint through a Vite environment variable instead of hardcoding it in the source code:
   ...
   ![Integrate the chatbot into the React frontend](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai22.jpg)
