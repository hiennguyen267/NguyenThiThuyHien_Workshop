...
3. Kiểm tra lại cấu hình và nhấn **Create bucket**.
   ...
   ![Khởi tạo S3 Bucket lưu trữ kho tri thức](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai1.jpg)
...
5. Kiểm tra tên tệp, dung lượng và trạng thái upload trước khi thực hiện quá trình indexing.
   ...
   ![Cấu trúc thư mục kho tri thức trên Amazon S3](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai2.jpg)
...
5. Mô hình tạo vector có kích thước **1024 dimensions** và hỗ trợ nhiều ngôn ngữ, phù hợp với kho tài liệu tiếng Việt của PharmaCare.
   ...
   ![Mô hình Cohere Embed Multilingual trên Amazon Bedrock](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai3.jpg)
...
3. Mô hình được dùng để tạo câu trả lời tự nhiên khi biến môi trường `ENABLE_LLM=true`.
   ...
   ![Mô hình Amazon Nova Micro trên Amazon Bedrock](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai4.jpg)
...
3. Cấu hình:
   ...
   * **Outbound rules:** Cho phép Lambda gửi yêu cầu HTTPS đến các dịch vụ AWS cần thiết.
   ...
   ![Security Group dành cho Lambda AI](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai5.jpg)
...
3. Outbound rule có thể giữ cấu hình mặc định.
   ...
   ![Security Group dành cho AI VPC Endpoint](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai6.jpg)
...
4. Tạo endpoint và kiểm tra trạng thái chuyển sang `Available`.
   ...
   ![S3 Gateway Endpoint cho Lambda AI](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai7.jpg)
...
6. Tạo thêm hai inline policy:
   ...
   * `pharmacare-rag-access-policy`.
   ...
   ![IAM Role dành cho Lambda Indexing và Lambda Chatbot](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai11.jpg)
...
```
   ...
   ![IAM Policy truy cập mô hình Bedrock](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai12.jpg)
...
```
   ...
   ![IAM Policy truy cập kho tri thức và Vector Store](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai13.jpg)
...
5. Ghi nhận OpenSearch endpoint để cấu hình cho Lambda.
   ...
   ![OpenSearch Serverless Vector Store của PharmaCare](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai14.jpg)
...
* **Permissions:**
  ...
  ```
   ...
   ![Data Access Policy cho OpenSearch Serverless](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai15.jpg)
...
4. Đóng gói mã nguồn cùng thư viện phụ thuộc và triển khai lên Lambda. Có thể sử dụng AWS Toolkit trong Visual Studio Code và nhấn **Deploy (Ctrl+Shift+U)**.
   ...
   ![Mã nguồn Lambda Indexing](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai16.jpg)
...
| `OPENSEARCH_INDEX` | `pharmacare-knowledge-index` |
   ...
   ![Environment Variables của Lambda Indexing](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai17.jpg)
...
5. Kết quả kiểm thử của hệ thống:
   ...
   * Ghi dữ liệu thành công vào OpenSearch Vector Store.
   ...
   ![Kết quả kiểm thử Lambda Indexing](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai18.jpg)
...
3. Triển khai mã nguồn chatbot lên Lambda.
   ...
   ![Lambda Chatbot của PharmaCare](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai19.jpg)
...
| `TOP_K` | `3` |
   ...
   ![Environment Variables của Lambda Chatbot](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai20.jpg)
...
* Không xuất hiện lỗi timeout, DNS hoặc thiếu quyền IAM.
   ...
   ![Kết quả kiểm thử Lambda Chatbot](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai21.jpg)
...
8. Cấu hình endpoint API bằng biến môi trường của Vite thay vì viết trực tiếp trong source code:
   ...
   ![Tích hợp Chatbot vào frontend React](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.5-chat-ai/ai22.jpg)
