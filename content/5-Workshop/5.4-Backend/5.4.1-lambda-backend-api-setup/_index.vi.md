...
![Tổng quan hàm Lambda backend](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/01-lambda-overview.png)
...
![Cấu hình Memory, Timeout và IAM Role](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/02-general-configuration.png)
...
![Cấu hình biến môi trường cho Lambda](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/03-environment-variables.png)
...
![Khởi tạo project và cài đặt thư viện Node.js](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/04-backend-project-dependencies.png)
...
![Đóng gói source code thành function.zip](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/05-package-lambda-code.png)
...
![Mã nguồn backend sau khi tải lên Lambda](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/06-upload-lambda-code.png)
...
![Chọn loại Amazon API Gateway HTTP API](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/07-select-http-api.png)

Trong phần **Integrations**, chọn Lambda function `pharmacare-backend-api` làm integration target.

![Tích hợp HTTP API với Lambda backend](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/08-configure-api-integration.png)
...
![Khai báo các route public](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/09-configure-public-routes.png)
...
![Cấu hình stage mặc định cho HTTP API](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/10-define-default-stage.png)

Kiểm tra lại integration, route và stage trước khi chọn **Create**.

![Kiểm tra cấu hình trước khi tạo API](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/11-review-create-api.png)

Sau khi API được tạo, kiểm tra danh sách route trong mục **Develop → Routes**.

![Danh sách route sau khi tạo HTTP API](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/12-api-routes-created.png)
...
![Cấu hình CORS cho ReactJS](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/13-configure-cors.png)
...
![Tạo Cognito JWT Authorizer](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/14-create-jwt-authorizer.png)

Sau khi tạo thành công, authorizer sẽ xuất hiện trong danh sách quản lý của API Gateway.

![JWT Authorizer sau khi được tạo](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/15-authorizer-created.png)
...
![Gắn Cognito Authorizer vào route GET profile](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/16-attach-authorizer-route.png)
...
![Kiểm tra đăng nhập bằng tài khoản Cognito](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/17-cognito-login-test.png)
...
![Tạo ứng dụng ReactJS bằng Vite](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/18-create-react-vite.png)
...
![Ứng dụng ReactJS chạy trên máy local](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/19-react-development-server.png)
...
![Code giao diện ReactJS dùng để kiểm thử](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/20-react-test-interface-code.png)
...
![Kết quả kiểm thử frontend, API Gateway và Lambda](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/21-api-test-result.png)
