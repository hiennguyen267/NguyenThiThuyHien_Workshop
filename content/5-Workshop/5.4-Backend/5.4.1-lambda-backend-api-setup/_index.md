...
![Lambda backend overview](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/01-lambda-overview.png)
...
![Lambda memory, timeout, and IAM role configuration](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/02-general-configuration.png)
...
![Lambda environment variables](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/03-environment-variables.png)
...
![Node.js backend project and dependencies](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/04-backend-project-dependencies.png)
...
![Packaging the Lambda deployment file](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/05-package-lambda-code.png)
...
![Lambda code after deployment](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/06-upload-lambda-code.png)

#### Step 8: Create an API Gateway HTTP API

Open **Amazon API Gateway → Create API** and select **HTTP API**.

![Selecting the HTTP API type](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/07-select-http-api.png)

Choose `pharmacare-backend-api` as the Lambda integration target.

![Integrating the HTTP API with Lambda](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/08-configure-api-integration.png)
...
![Public HTTP API routes](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/09-configure-public-routes.png)

#### Step 10: Configure the stage

Use the `$default` stage and enable **Auto-deploy**.

![Default stage configuration](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/10-define-default-stage.png)

Review the integrations, routes, and stage, then create the API.

![HTTP API review page](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/11-review-create-api.png)

Verify the routes under **Develop → Routes**.

![HTTP API routes after creation](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/12-api-routes-created.png)
...
![CORS configuration for the local frontend](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/13-configure-cors.png)
...
![Creating the Cognito JWT Authorizer](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/14-create-jwt-authorizer.png)

![JWT Authorizer after creation](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/15-authorizer-created.png)
...
![Attaching the authorizer to GET profile](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/16-attach-authorizer-route.png)
...
![Cognito sign-in test](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/17-cognito-login-test.png)
...
![Creating the React application with Vite](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/18-create-react-vite.png)
...
![React development server](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/19-react-development-server.png)
...
![React test interface code](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/20-react-test-interface-code.png)
...
![End-to-end test result](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.4-lambda-backend/5.4.1-lambda-backend-api-setup/21-api-test-result.png)
