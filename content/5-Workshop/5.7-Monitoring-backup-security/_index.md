...
4. Verify the PharmaCare log groups:
   ...
   ![PharmaCare CloudWatch Log Groups](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs1.jpg)
...
6. Verify that the topic was created successfully.
   ...
   ![Create the PharmaCare SNS alert topic](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs2.jpg)
...
5. Verify that the subscription initially displays:
   ...
   ![Create an email subscription for the SNS Topic](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs3.jpg)
...
```
   ...
   ![PharmaCare CloudWatch Alarms](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs4.jpg)
...
6. Create the backup plan.
   ...
   ![AWS Backup Plan for Amazon RDS](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs5.jpg)
...
4. Save the resource assignment.
   ...
   ![Assign Amazon RDS to the AWS Backup Plan](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs6.jpg)
...
6. During the initial evaluation period, use **Monitor mode** before enforcing blocking actions.
   ...
   ![AWS WAF associated with the CloudFront Distribution](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs7.jpg)
...
```
   ...
   ![Backend Lambda IAM Role and policies](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs8.jpg)
...
```
   ...
   ![AI RAG Lambda IAM Role and policies](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs9.jpg)
