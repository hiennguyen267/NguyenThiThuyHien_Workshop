...
4. Kiểm tra các log group của hệ thống PharmaCare:
   ...
   ![Danh sách CloudWatch Log Groups của PharmaCare](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs1.jpg)
...
6. Kiểm tra topic được tạo thành công.
   ...
   ![Tạo SNS Topic gửi cảnh báo PharmaCare](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs2.jpg)
...
5. Kiểm tra trạng thái subscription:
   ...
   ![Tạo Email Subscription cho SNS Topic](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs3.jpg)
...
```
   ...
   ![Danh sách CloudWatch Alarm của PharmaCare](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs4.jpg)
...
6. Hoàn tất tạo backup plan.
   ...
   ![AWS Backup Plan cho Amazon RDS](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs5.jpg)
...
4. Lưu cấu hình resource assignment.
   ...
   ![Gán Amazon RDS vào AWS Backup Plan](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs6.jpg)
...
6. Trong giai đoạn đầu, có thể chạy ở **Monitor mode** để theo dõi request trước khi áp dụng chặn.
   ...
   ![AWS WAF được gắn với CloudFront Distribution](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs7.jpg)
...
```
   ...
   ![IAM Role và policy của Backend Lambda](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs8.jpg)
...
```
   ...
   ![IAM Role và policy của Lambda AI RAG](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.7-mbs/mbs9.jpg)
