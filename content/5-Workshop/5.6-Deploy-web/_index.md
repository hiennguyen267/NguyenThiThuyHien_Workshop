...
5. Review the settings and click **Create bucket**.
   ...
   ![Create an S3 bucket for the PharmaCare frontend](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.6-deploy-web/deploy1.jpg)

After the bucket is created, open it and confirm that the **Objects** tab is empty.

   ![Frontend S3 bucket created successfully](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.6-deploy-web/deploy2.jpg)
...
7. Confirm that the bucket contains the main objects:
   ...
   ![Upload the dist build files to Amazon S3](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.6-deploy-web/deploy3.jpg)
...
5. Wait until the distribution status changes to **Enabled**.
   ...
   ![Create a CloudFront Distribution for the PharmaCare website](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.6-deploy-web/deploy4.jpg)
...
5. Create another response for the `404` error:
   ...
   * **HTTP response code:** `200`.
   ...
   ![Configure CloudFront Error Pages for React Router](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.6-deploy-web/deploy5.jpg)
...
6. Wait until the status changes from `In progress` to `Completed`.
   ...
   ![Create a CloudFront Invalidation after updating the frontend](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.6-deploy-web/deploy6.png)
...
8. Click **Save changes**.
   ...
   ![Update callback and sign-out URLs in Amazon Cognito](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.6-deploy-web/deploy7.png)
...
10. Complete the payment and verify the registration email.
   ...
   ![Search for and register a PharmaCare domain in Route 53](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.6-deploy-web/deploy8.jpg)
