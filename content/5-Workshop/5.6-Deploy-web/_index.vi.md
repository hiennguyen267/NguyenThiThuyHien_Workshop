...
5. Kiểm tra lại cấu hình và nhấn **Create bucket**.
   ...
   ![Tạo S3 bucket lưu trữ frontend PharmaCare](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.6-deploy-web/deploy1.jpg)

Sau khi tạo thành công, mở bucket và xác nhận giao diện **Objects** chưa có dữ liệu.

   ![S3 bucket frontend được tạo thành công](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.6-deploy-web/deploy2.jpg)
...
7. Kiểm tra bucket có các đối tượng chính:
   ...
   ![Tải các tệp build trong thư mục dist lên Amazon S3](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.6-deploy-web/deploy3.jpg)
...
5. Chờ trạng thái distribution chuyển sang **Enabled**.
   ...
   ![Tạo CloudFront Distribution cho website PharmaCare](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.6-deploy-web/deploy4.jpg)
...
5. Tạo thêm cấu hình cho lỗi `404`:
   ...
   * **HTTP response code:** `200`.
   ...
   ![Cấu hình CloudFront Error Pages cho React Router](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.6-deploy-web/deploy5.jpg)
...
6. Chờ trạng thái chuyển từ `In progress` sang `Completed`.
   ...
   ![Tạo CloudFront Invalidation sau khi cập nhật frontend](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.6-deploy-web/deploy6.png)
...
8. Nhấn **Save changes**.
   ...
   ![Cập nhật Callback URL và Sign-out URL trong Amazon Cognito](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.6-deploy-web/deploy7.png)
...
10. Hoàn tất thanh toán và xác minh email đăng ký.
   ...
   ![Tìm kiếm và đăng ký domain cho PharmaCare trong Route 53](/NguyenThiThuyHien_Workshop/images/5-Workshop/5.6-deploy-web/deploy8.jpg)
