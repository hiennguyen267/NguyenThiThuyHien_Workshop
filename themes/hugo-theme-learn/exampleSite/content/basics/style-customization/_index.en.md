...
If your favicon is a png, just drop off your image in your local `static/NguyenThiThuyHien_Workshop/images/` folder and name it `favicon.png`
...
![Red variant](/en/basics/style-customization/NguyenThiThuyHien_Workshop/images/red-variant.png?width=60pc)
...
![Blue variant](/en/basics/style-customization/NguyenThiThuyHien_Workshop/images/blue-variant.png?width=60pc)
...
![Green variant](/en/basics/style-customization/NguyenThiThuyHien_Workshop/images/green-variant.png?width=60pc)
