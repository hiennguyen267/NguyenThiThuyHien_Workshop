...
Si votre favicon est un png, déposez votre image dans votre dossier local `static/NguyenThiThuyHien_Workshop/images/` et nommez le `favicon.png`
...
```html
<link rel="shortcut icon" href="/NguyenThiThuyHien_Workshop/images/favicon.png" type="image/x-icon" />
```
...
![Variante rouge](/en/basics/style-customization/NguyenThiThuyHien_Workshop/images/red-variant.png?width=60pc)
...
![Variante bleue](/en/basics/style-customization/NguyenThiThuyHien_Workshop/images/blue-variant.png?width=60pc)
...
![Variante verte](/en/basics/style-customization/NguyenThiThuyHien_Workshop/images/green-variant.png?width=60pc)
